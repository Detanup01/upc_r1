...
if exist "G:\VS\VS_Community\VC\Auxiliary\Build\vcvars32.bat" goto vs2019
if exist "G:\VS\VS_Community\VC\Auxiliary\Build\vcvars32.bat" goto vs2017
...
:vs2019
call "G:\VS\VS_Community\VC\Auxiliary\Build\vcvars32.bat"
goto batend
